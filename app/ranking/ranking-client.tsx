...
function matchesSchoolQuery(name: string, query: string) {
  ...
  const normalizedQuery = normalizeSchoolName(query.trim());
            ...
            <div className="flex flex-col gap-3">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-stone-600">
                  대학명을 입력하면 원하는 학교를 빠르게 찾을 수 있어요. 예를 들어
                  `경성대`, `경성대학교`, `경성`, `경`처럼 검색해도 관련 학교를
                  아래에서 볼 수 있어요.
                </p>
              </div>
